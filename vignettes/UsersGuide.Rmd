...
example_dataset <- system.file("extdata", "scRNAseq_dataset.txt", package = "SingleCellSignalR")
...
```{r}
matrix <- system.file("extdata", "mouse_scRNAseq_dataset.txt", package = "SingleCellSignalR")
